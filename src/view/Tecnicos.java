...
public class Tecnicos extends JDialog {
	...
	public Tecnicos() {
		...
		setModal(true);
		setTitle("Marvi Cold - Técnicos");
		setIconImage(Toolkit.getDefaultToolkit().getImage(Tecnicos.class.getResource("/img/technician.png")));
		setBounds(100, 100, 440, 273);
		...
		btnCreate.setBounds(12, 179, 52, 52);
		...
		btnLimpar.setBounds(363, 179, 52, 52);
		...
		btnUpdate.setBounds(76, 179, 52, 52);
		...
		btnDelete.setBounds(140, 179, 52, 52);
		...
		lblNewLabel_3.setToolTipText("Digite o Nome para fazer Busca");
		lblNewLabel_3.setIcon(new ImageIcon(Tecnicos.class.getResource("/img/search-marvi.png")));
		lblNewLabel_3.setBounds(383, 44, 32, 32);
